...
public class Cassian extends Lutador{
    ...
    public Cassian() {
        super("Cassian", 120,120, 11, 3, 1, Tipo.COMBATENTES, Status.NORMAL);
    }
    ...
    public void mostraInformacoes(){
        JOptionPane.showMessageDialog(null, """
                                            Cassian é um paladino devoto do Deus da Luz, ele é conhecido por sua força e coragem em batalha, alguém de sua habilidade de curar a si mesmo e aos outros.
    ...
    public void mostraDetalhesHabilidadePadrao(){
        JOptionPane.showMessageDialog(null, """
                                            Com disciplina e precisão, o paladino desfere um golpe firme com sua espada sagrada, canalizando uma pequena parcela de sua fé no ataque.
                                            Dano: """ + this.dano);
    }
    ...
    public void mostraDetalhesHabilidadeEspecial(){
        JOptionPane.showMessageDialog(null, """
                                            O paladino invoca a luz de sua divindade. Sua espada brilha com uma aura dourada antes de desferir um golpe poderoso que cai sobre o inimigo como um julgamento celestial.
    ...
    public void mostraDetalhesHabilidadePassiva(){
        JOptionPane.showMessageDialog(null, """
                                            O paladino ergue sua espada e faz uma breve oração. A luz divina envolve seu corpo, fortalecendo sua armadura e guiando seus próximos ataques.
                                            Dano: 0
