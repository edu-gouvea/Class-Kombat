...
const arenas = [
  ...
  { id: 2, name: "Castelo Draaven", img: dravenImg, border: "border-red-600" },
  {
    id: 3,
  ...
  { id: 6, name: "Abismo Korvus", img: korvusImg, border: "border-red-800" },
];
...
const EscolhaArena = ({ onVoltar, onConfirmar }) => {
  ...
  return (
    <div className="min-h-screen w-screen text-white flex flex-col items-center py-8 font-mono border-[12px] border-double border-slate-900 overflow-x-hidden relative">
