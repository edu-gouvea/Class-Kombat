...
const EscolhaModo = ({ onSelecionarModo, onVoltar }) => {
  return (
    <div className="h-screen w-screen bg-black text-white flex flex-col items-center justify-center font-mono relative overflow-hidden border-[12px] border-double border-slate-900">
      {/* Botão Voltar Estilo "Coin" */}
      <button
        onClick={onVoltar}
      ...
      {/* Opções de Modo - Estilo Arcade */}
      <div className="flex flex-col md:flex-row gap-12 z-10 w-full max-w-5xl px-8">
        {/* Card PvE - Player vs CPU */}
        <div
      ...
      {/* Overlay Scanlines (Efeito de Linhas da TV) */}
