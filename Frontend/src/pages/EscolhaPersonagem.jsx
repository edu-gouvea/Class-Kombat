...
const EscolhaPersonagem = ({ onVoltar, onConfirmar }) => {
  ...
  return (
    <div className="min-h-screen w-screen bg-black text-white flex flex-col items-center py-8 font-mono relative overflow-x-hidden border-[12px] border-double border-slate-900">
      {/* Botão Voltar Estilo Arcade */}
      <button
        onClick={onVoltar}
